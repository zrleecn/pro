...
<head>
    ...
    <link rel="stylesheet" href="/web/shop/Public/css/contact.css">
    ...
    <div class="row">
        <div class="header-nav">
            <ul class="nav nav-pills  center-block">
                ...
                <li  class="active"><a href="/web/shop/index.php/Home/Index/contact">联系客服</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="container contact">
    <div class="row">
        ...
        <div>
            <form class="form" method="post" action="/web/shop/index.php/Home/Contact/send">
