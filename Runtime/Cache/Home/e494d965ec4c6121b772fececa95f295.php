...
<head>
    ...
    <link rel="stylesheet" href="/web/shop2/Public/css/goods_detail.css">
    <link rel="stylesheet" href="/web/shop2/Public/css/zyComment.css">
    <link rel="stylesheet" href="/web/shop2/Public/css/semantic.css">
    <title>详细信息</title>
</head>
...
<div class="container detail-header" data-islogin="<?php echo ($is_login); ?>">
    <div class="row de-title">
        <!--返回-->
        <a href="/web/shop2/index.php/<?php echo ($url); ?>"><div class="col-xs-3 "><i class="fa fa-angle-left" aria-hidden="true"></i></div></a>
...
<div class="container no-pa">
    ...
    <div class="row no-pa">
        <img src="/web/shop2/Public/<?php echo ($goodsInfo["thumb_image"]); ?>" width="100%" height="260" alt="">
    </div>
...
<script type="text/javascript" src="/web/shop2/Public/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="/web/shop2/Public/js/zyComment.js"></script>
...
<script type="text/javascript">
    ...
    function reply(){
        ...
        $.ajax({
            type:"post" ,
            url :"/web/shop2/index.php/Home/Goods/addNewComment",
            data:{
                "goods_id":goods_id,
                "user_name":user_name,
                "content": content,
