...
<script>
    $(function (){
        ...
        (function (){
            $('.fa-heart').click(function () {
                ...
                if(is_login){
                    $.ajax({
                        type:"post",
                        url:"/web/shop2/index.php/Admin/User/add_collect",
                        data:{
                            "goods_id":goods_id
                        },
       ...
       // /web/shop2/index.php/Admin/User/add_collect/goods_id/<?php echo ($v["goods_id"]); ?>
    ...
    <div class="row">
        <div class="header-nav">
            <ul class="nav nav-pills  center-block">
                <li class="active"><a href="/web/shop2/index.php/Home/Index/index">首页</a></li>
...
<div style="height:50px;">
    ...
    <div id='example-carousel' class="carousel slide" data-ride='carousel'>
        ...
        <div class="carousel-inner">
            <div class="item active" >
                <img src="/web/shop2/Public/images/drawing.jpg"/>
            ...
            <div class="item" >
                <img src="/web/shop2/Public/images/cactus-.jpg"/>
                <div class="carousel-caption">
                    <!--<h4>HTML5 in BootStrap</h4>-->
                </div>
            </div>
            <div class="item" >
                <img src="/web/shop2/Public/images/bicycle.jpg"/>
                <div class="carousel-caption">
    ...
    <div class="container ad">
        <div class="ad-header row center-block">
            ...
            <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/2/active_index/2"><div class="cycle-radius pull-left"><i class="fa fa-bicycle" aria-hidden="true"></i></div></a>
            <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/1/active_index/1"><div class="cycle-radius pull-left"><i class="fa fa-book" aria-hidden="true"></i></div></a>
            <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/5/active_index/5"> <div class="cycle-radius pull-left"><i class="fa fa-desktop" aria-hidden="true"></i></div></a>
             <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/5/active_index/5"><div class="cycle-radius pull-left"><i class="fa fa-mobile" aria-hidden="true"></i></div></a>
            <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/7/active_index/7"><div class="cycle-radius pull-left"><i class="fa fa-sun-o" aria-hidden="true"></i></div></a>
            <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/5/active_index/5"><div class="cycle-radius pull-left"><i class="fa fa-keyboard-o" aria-hidden="true"></i></div></a>
             <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/3/active_index/3"><div class="cycle-radius pull-left"><i class="fa fa-music" aria-hidden="true"></i></div></a>
             <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/5/active_index/5"> <div class="cycle-radius pull-left"><i class="fa fa-desktop" aria-hidden="true"></i></div></a>
             <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/5/active_index/5"> <div class="cycle-radius pull-left"><i class="fa fa-laptop" aria-hidden="true"></i></div></a>
             <a href="/web/shop2/index.php/Home/Goods/showlist/cat_id/5/active_index/5"> <div class="cycle-radius pull-left"><i class="fa fa-video-camera" aria-hidden="true"></i></div></a>
    ...
    <div class="container goods-item" data-islogin="<?php echo ($is_login); ?>" >
        <div class="row">
            <?php if(is_array($goods)): foreach($goods as $key=>$v): ?><div class="col-xs-6" style="padding-right: 0px !important;padding-left:0px">
                    <div class="thumbnail">
                        <a href="/web/shop2/index.php/Home/Goods/goods_detail/goods_id/<?php echo ($v["goods_id"]); ?>/url/Home.Index.index" target="_top">
                            <img src="/web/shop2/Public/<?php echo ($v["thumb_image"]); ?>" alt="...">
                        </a>
                        <div class="caption">
                            <a style="color: #555;" href="/web/shop2/index.php/Home/Goods/goods_detail/goods_id/<?php echo ($v["goods_id"]); ?>/url/Home.Index.index" target="_top"> <span class="goods-name"><?php echo ($v["goods_name"]); ?></span></a><br>
