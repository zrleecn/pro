...
<head>
    ...
    <link rel="stylesheet" href="/web/shop2/Public/css/goods.css">
...
<!--加载商品-->
    <div class="row">
        <?php if(is_array($goods)): foreach($goods as $key=>$v): ?><div class="col-xs-6">
                <div class="thumbnail">
                    <a href="/web/shop2/index.php/Home/Goods/goods_detail/goods_id/<?php echo ($v["goods_id"]); ?>/url/Home.Goods.showlist" target="_top">
                        <img src="/web/shop2/Public/<?php echo ($v["thumb_image"]); ?>" alt="...">
                    </a>

                    <div class="caption">
                        <a style="color: #555" href="/web/shop2/index.php/Home/Goods/goods_detail/goods_id/<?php echo ($v["goods_id"]); ?>/url/Home.Goods.showlist" target="_top"><span class="goods-name"><?php echo ($v["goods_name"]); ?></span></a><br>
