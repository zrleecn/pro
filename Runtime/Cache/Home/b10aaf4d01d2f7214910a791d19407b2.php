...
<head>
    ...
    <link rel="stylesheet" href="/web/shop2/Public/css/goods_list.css">
    ...
    <div class="row">
        <div class="header-nav">
            <ul class="nav nav-pills  center-block">
                ...
                <li class="active" ><a href="/web/shop2/index.php/Home/Goods/showlist">商品</a></li>
...
<div class="container">
    <div class="row search-form">
        <form action="/web/shop2/index.php/Home/Goods/search" method="post" class="form">
            <div class="form-group has-feedback">
                <a class="btn btn-default pull-left col-xs-2 go-back" href="/web/shop2/index.php/Home/Goods/showlist">&nbsp;&nbsp;<i class="fa fa-angle-left " aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;</a>
    ...
    <div class="row">
        <div class="col-xs-3 left-cat pull-left">
            <div class="list-group cat-list">
                <?php if(is_array($category)): foreach($category as $key=>$v): ?><a href="/web/shop2/index.php/Home/Goods/goods/cat_id/<?php echo ($v["cat_id"]); ?>" target="right" class="list-group-item" ><?php echo ($v["cat_name"]); ?></a><?php endforeach; endif; ?>
        ...
        <!--右侧商品详细-->
        <iframe class="col-xs-9 main-cat pull-right" src="/web/shop2/index.php/Home/Goods/goods/cat_id/<?php echo ($cid); ?>" frameborder="0" name="right">
