...
<div class="container sub-nav" style="padding: 0;">
    <div class="row" style="position: relative;padding: 0;margin: 0;">
        ...
        <div class="col-xs-4 nav-menu">
            <p class="lead my-goods active"><a href="/web/shop2/index.php/Admin/Index/my" class="active">我的商品</a><span class="badge"><?php echo ($mygoodscount); ?></span><span style="font-size: 20px;position: absolute;top: -4px;right: 5%;">|</span></p>
        </div>
        <!--<div class="" style="padding-top: 0;position: relative;">-->
            <!--<span style="font-size: 20px;position: absolute;top: -4px;">|</span>-->
        <!--</div>-->
        <div class="col-xs-4 nav-menu">
            <p class="lead my-goods"><a href="/web/shop2/index.php/Admin/Index/collection">我的收藏</a><span class="badge"><?php echo ($col_count); ?></span></p>
        </div>
        <div class="col-xs-1">
            <!--个人-->
...
<div class="container " >
    <div class="row">
        <?php if(is_array($goods)): foreach($goods as $key=>$v): ?><div class="col-xs-6 goods_list" >
                <div class="thumbnail">
                    <a href="/web/shop2/index.php/Home/Goods/goods_detail/goods_id/<?php echo ($v["goods_id"]); ?>/url/Admin.Index.my" target="_top">
                        <img src="/web/shop2/Public/<?php echo ($v["thumb_image"]); ?>" alt="...">
                    </a>   
                    <div class="caption">
                        <a style="color: #555;" href="/web/shop2/index.php/Home/Goods/goods_detail/goods_id/<?php echo ($v["goods_id"]); ?>/url/Home.Goods.showlist" target="_top">
                        ...
                        <!--<a href="/web/shop2/index.php/Admin/Goods/delete_goods/goods_id/<?php echo ($v["goods_id"]); ?>" onclick="return confirm('确定要删除<?php echo ($v["goods_name"]); ?>?')">-->
        ...
        <?php if(count($goods) < 1): ?><h1 style="margin-left: 20px;font-size: 50px">:(</h1>
            ...
            <h3><a href="/web/shop2/index.php/Admin/Goods/upload_goods" style="color: deepskyblue;margin-left: 20px;text-decoration: underline">马上上传</a></h3><?php endif; ?>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="/web/shop2/index.php/Admin/Goods/delete_goods/goods_id/" type="button" class="btn-ok btn btn-primary btn-lg">确定</a>
