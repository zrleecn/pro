...
<head>
    ...
    <link rel="stylesheet" href="/web/shop2/Admin/Public/css/manager.css">
...
<session >
    ...
    <div class="container header-bar">
        <div class="row ">
            ...
            <a class="btn btn-default pull-left col-xs-2 go-back" href="/web/shop2/index.php/Admin/Index/my">&nbsp;&nbsp;<i class="fa fa-chevron-left " aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;</a>
            <div class="pull-left col-xs-8 h-title">

                <h4 class="text-center">我的二手市场</h4>

            </div>
            <a class="btn btn-default pull-left col-xs-2 go-back" href="/web/shop2/index.php/Home/Goods/showlist">&nbsp;&nbsp;<i class="fa fa-shopping-cart " aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;</a>
...
<session class="container my-info">
    ...
    <div class="row">
        ...
        <div class="col-xs-11">
            <img src="/web/shop2/Public/<?php echo ((isset($user_info["head_portrait"]) && ($user_info["head_portrait"] !== ""))?($user_info["head_portrait"]):'images/default_head.png'); ?>" class="head-portrait animated bounceInRight" width="80" height="80" alt="">
...
<session class="container menu-list">
    <ul class="list-group">
        ...
        <a href="/web/shop2/index.php/Admin/Index/my">
            <li class="list-group-item">
        ...
        <a href="/web/shop2/index.php/Admin/Index/collection">
            <li class="list-group-item">
        ...
        <a href="/web/shop2/index.php/Admin/Manager/modify">
            <li class="list-group-item">
        ...
        <a href="/web/shop2/index.php/Admin/Manager/myinfo">
            <li class="list-group-item">
    ...
    <ul class="list-group">
        ...
        <a href="/web/shop2/index.php/Home/Index/contact">
            <li class="list-group-item">
        ...
        <a href="/web/shop2/index.php/admin/user/logout">
            <li class="list-group-item">
                <i class="fa fa-whatsapp" aria-hidden="true"></i>
                <span>退出登录</span>
                <span><i class="fa fa-angle-right pull-right" aria-hidden="true"></i></span>
