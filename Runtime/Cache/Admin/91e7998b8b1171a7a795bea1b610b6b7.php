...
<div class="container sub-nav">
    <div class="row" style="position: relative;">
        ...
        <div class="col-xs-4 nav-menu">
            <p class="lead my-goods"><a href="/web/shop/index.php/Admin/Index/my" class="">我的商品</a><span class="badge"><?php echo ($mygoodscount); ?></span><span style="font-size: 20px;position: absolute;top: -4px;right: 2px;">|</span></p>
        </div>
        <!--<div class="col-xs-1" style="padding-top: 0;position: relative;">-->
            <!--<span style="font-size: 20px;position: absolute;top: -4px;">|</span>-->
        <!--</div>-->
        <div class="col-xs-4 nav-menu">
            <p class="lead my-goods"><a href="/web/shop/index.php/Admin/Index/collection" class="active">我的收藏</a><span class="badge"><?php echo ($col_count); ?></span></p>
        </div>
        <div class="col-xs-1">
            <!--个人-->
...
<div class="container " >
    <div class="row">
        <?php if(is_array($goods)): foreach($goods as $key=>$v): ?><div class="col-xs-6 goods_list" >
                <div class="thumbnail">
                    <a href="/web/shop/index.php/Home/Goods/goods_detail/goods_id/<?php echo ($v["goods_id"]); ?>/url/Admin.Index.collection" target="_top">
                        <img src="/web/shop/Public/<?php echo ($v["thumb_image"]); ?>" alt="...">
                    </a>   
                    <div class="caption">
                        <a style="color: #555;" href="/web/shop/index.php/Home/Goods/goods_detail/goods_id/<?php echo ($v["goods_id"]); ?>/url/Admin.Index.collection" target="_top">
                        ...
                        <!--<a href="/web/shop/index.php/Admin/Goods/delete_collection/goods_id/<?php echo ($v["goods_id"]); ?>" onclick="return confirm('确定要删除收藏的<?php echo ($v["goods_name"]); ?>?')">-->
        ...
        <?php if(count($goods) < 1): ?><h1 style="margin-left: 20px;font-size: 50px">:(</h1>
            ...
            <h3><a href="/web/shop/index.php/Home/Goods/showlist" style="color: deepskyblue;margin-left: 20px;text-decoration: underline">现在去浏览商品</a></h3><?php endif; ?>
