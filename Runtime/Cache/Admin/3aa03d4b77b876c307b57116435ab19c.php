...
<head>
    ...
    <link rel="stylesheet" href="/web/shop2/Admin/Public/css/modify.css">
...
<session >
    ...
    <div class="container header-bar">
        <div class="row ">
            ...
            <a class="btn btn-default pull-left col-xs-2 go-back" href="/web/shop2/index.php/Admin/Manager/myinfo">&nbsp;&nbsp;<i class="fa fa-user " aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;</a>
...
<session class="container modify-form">
    <form class="form-horizontal" method="post" action="/web/shop2/index.php/Admin/Manager/modify_update">
        ...
        <div class="form-group">
            <div class="col-xs-offset-3">
                ...
                <a href="/web/shop2/index.php/Admin/Manager/manager" class="btn btn-danger btn-lg cancel">取消</a>
            </div>
